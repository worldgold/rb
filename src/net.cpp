...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Robocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"robocointools.com", "184.95.41.67"},   
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"robocointools.com", "testnet-seed.robocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Robocoin is probably already running."), addrBind.ToString().c_str());
        else
